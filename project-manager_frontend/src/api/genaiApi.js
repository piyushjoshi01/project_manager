 ...
 */
export const syncProjectIssues = async (projectKey) => {
 ...
 */
export const getProjectLLMData = async (projectKey) => {
 ...
 * @returns Success message
 */
export const updateAssigneeCost = async (accountId, hourlyCost) => {
 ...
 */
export const askLLM = async (prompt, projectKey) => {
